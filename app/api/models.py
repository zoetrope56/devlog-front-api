...
class ContentsDetail(TimestampedModel):
    ...
    ctnt_path = models.CharField(db_column='CTNT_PATH', max_length=200, blank=True, null=True, db_comment='콘텐츠 파일 경로')  # Field name made lowercase.
    ctnt_name = models.CharField(db_column='CTNT_NAME', max_length=200, blank=True, null=True, db_comment='콘텐츠 파일 이름')  # Field name made lowercase.
    ctnt_ext = models.CharField(db_column='CTNT_EXT', max_length=200, blank=True, null=True, db_comment='콘텐츠 파일 확장자')  # Field name made lowercase.
...
class File(TimestampedModel):
    file_no = models.AutoField(db_column='FILE_NO', primary_key=True, db_comment='콘텐츠 제목')  # Field name made lowercase.
    file_path = models.CharField(db_column='FILE_PATH', max_length=200, blank=True, null=True, db_comment='파일 경로')  # Field name made lowercase.
    file_name = models.CharField(db_column='FILE_NAME', max_length=200, blank=True, null=True, db_comment='파일 이름')  # Field name made lowercase.
    file_ext = models.CharField(db_column='FILE_EXT', max_length=200, blank=True, null=True, db_comment='파일 확장자')  # Field name made lowercase.
    ctnt_no = models.IntegerField(db_column='CTNT_NO', blank=True, null=True, db_comment='콘텐츠 번호')  # Field name made lowercase.
    # inp_dttm = models.DateTimeField(db_column='INP_DTTM', blank=True, null=True, db_comment='입력일시')  # Field name made lowercase.
    # upd_dttm = models.DateTimeField(db_column='UPD_DTTM', blank=True, null=True, db_comment='수정일시')  # Field name made lowercase.
...
class User(TimestampedModel):
    user_no = models.AutoField(db_column='USER_NO', primary_key=True, db_comment='유저번호')  # Field name made lowercase.
    username = models.CharField(db_column='USERNAME', max_length=30, blank=True, null=True, db_comment='유저명')  # Field name made lowercase.
    password = models.CharField(db_column='PASSWORD', max_length=100, blank=True, null=True, db_comment='비밀번호')  # Field name made lowercase.
    grant = models.CharField(db_column='GRANT', max_length=10, blank=True, null=True, db_comment='사용자 권한')  # Field name made lowercase.
    # inp_dttm = models.DateTimeField(db_column='INP_DTTM', blank=True, null=True, db_comment='입력일시')  # Field name made lowercase.
    # upd_dttm = models.DateTimeField(db_column='UPD_DTTM', blank=True, null=True, db_comment='수정일시')  # Field name made lowercase.
